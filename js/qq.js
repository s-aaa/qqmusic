...
var uireset=function(){
    ...
    document.querySelector('.musicname').innerHTML='<span>我想听的歌</span>';
    document.querySelector('.singername').innerHTML='<span>QQ音乐</span>';
    document.querySelector('.music_op').style.display='none';
    document.querySelector('.playdate').style.display='none';
    audio.src='';
...
if(audio.paused){//音乐暂停时
    audio.play();
    document.querySelector('.musicname').innerHTML='<span>'+yinyueku[0].name+'</span>';
    document.querySelector('.singername').innerHTML='<span>'+yinyueku[0].geshou+'</span>';
    document.querySelector('.music_op').style.display='block';
    document.querySelector('.playdate').style.display='block';
    document.querySelector('.playdate').innerHTML=yinyueku[0].duration;
    currentsongindex=-1;
    nextsong();
